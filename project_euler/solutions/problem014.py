def get_answer(bound=1_000_000):
    ...
    # The longest sequence must be greater than bound // 2.
    # Proof: If n is even, Collatz(n) = Collatz(n // 2) + 1.  Therefore, Collatz(2n) > Collatz(n).
    # Therefore no point looking at values less than bound // 2
